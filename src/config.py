...
cods = ["0f", "1e", "2e", "3d", "4d", "5d", "6d", "7d", "8d", "9a", "10a", "11a", "12a", "12b", "12c", "13b", "14a", "14c", "15a", "16c", "17a", "18a", "19a", "20a", "21a", "22a", "23a", "24a"]

paper_datasets = [('imagenet-sketch', 1), ('cifar10', 0), ('fgvc-aircraft', 0), ('ILSVRC/imagenet-1k', 0)]
datasets = [('imagenet-sketch', 1), ('cifar10', 0), ('fgvc-aircraft', 0), ('ILSVRC/imagenet-1k', 0), ('imagenet-c-gaussian_noise-1', 0), ('imagenet-c-gaussian_noise-3', 0), ('imagenet-c-gaussian_noise-5', 0), ('imagenet-c-jpeg_compression-1', 0), ('imagenet-c-jpeg_compression-3', 0), ('imagenet-c-jpeg_compression-5', 0), ('imagenet-c-motion_blur-1', 0), ('imagenet-c-motion_blur-3', 0), ('imagenet-c-motion_blur-5', 0), ('imagenet-c-fog-1', 0), ('imagenet-c-fog-3', 0), ('imagenet-c-fog-5', 0)]

instances = [
        ('huggingface', 'facebook/dino-vitb16', 'DEFAULT'),
